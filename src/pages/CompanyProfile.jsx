    ...
    <>
      <Transition appear show={open ?? false} as={Fragment}>
        <Dialog as='div' className='relative z-10' onClose={closeModal}>
          ...
          <div className="fixed inset-0 overfloy-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                ...
                >
                  ...
                  <form onSubmit={handleSubmit(onSubmit)} className="w-full mt-2 flex flex-col gap-5">
                    <TextInput
                      name='name'
                      label='Company Name'
                      type='text'
                    ...
                    <div className="w-full flex gap-2">
                      ...
                      <div className="w-1/2 mt-2">
                        <label className="text-gray-800 text-sm mb-1">
                          Company Logo
                        </label>
                        <input
                          type="file"
                    ...
                    <div className="flex flex-col">
                      ...
                      <textarea className="rounded border-gray-400 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 text-base px-4 py-2 resize-none" cols={6} rows={4} {...register("about", {
                        required: 'Write a little about your Company'
                    ...
                    <div className="mt-4">
                      <CustomButton
                        type='submit'
                        containerStyles='inline-flex justify-center rounded-md border border-transparent bg-blue-500 px-8 py-2 text-sm font-medium text-white hover:bg-[#1d4fd846] hover:text-[#1d4fd846] hover:text-[#1d4fd846] focus:outline-none'
                        title={"Submit"}
                      />
                    </div>
                  </form>
    ...
    <div className="container mx-auto p-5">
      <div className="">
              ...
              <div className="flex items-center justify-center py-5 md:py-0 gap-4">
                ...
                <Link to="/upload-job">
                  <CustomButton
                    title="Upload Job"
                    iconRight={<FiUpload />}
                    containerStyles={`text-blue-600 py-1.5 px-5 md:px-5 focus:outline-none rounded text-sm md:text-base border border-blue-600`}
                  />
                </Link>
              </div>
            )}
        ...
        <div className="w-full flex flex-col md:flex-row justify-start md:justify-between mt-4 md:mt-8 text-sm">
          ...
          <p className="flex gap-1 items-center px-3 py-1 text-slate-600 rounded-full">
            <FiPhoneCall /> {info?.contact ?? "No Phone"}
          </p>
